...
document.addEventListener('DOMContentLoaded', () => {
    ...
    "./images/dungeon_1.png", // Dungeon 1 (overworld)
    "./images/dungeon_2.png", // Dungeon 2 (desert)
    "./images/dungeon_3.png",  // Dungeon 3 (catacomb)
    "./images/dungeon_4.png", // Dungeon 4 (jungle)
];
    const CLASS_DATA = {
...
const ENEMY_SPRITES = {
    // Dungeon 1 - Overworld
    'Rat': {
        src: './images/enemy_rat.png',
        width: 70,
        height: 70,
        fallbackText: 'Rat',
    },
    'Goblin': {
        src: './images/asset_Xcu9zE2.png',
        width: 80,
        height: 80,
        fallbackText: 'Gob',
    },
    'Kobold': {
        src: './images/asset_6pzi1E0.png',
        width: 80,
        height: 80,
        fallbackText: 'Kob',
    },
    'White Dragon': {
        src: './images/asset_CKrfmRI.png',
        width: 154,
        height: 154,
        fallbackText: 'Whi',
    },
    'Sand Worm': {
        src: './images/asset_xBJ4Zjs.png',
        width: 110,
        height: 110,
        fallbackText: 'San',
},
    'Mummy': {
        src: './images/asset_wYb4a7D.png',
        width: 90,
        height: 90,
        fallbackText: 'Mum',
},
'Thief': {
    src: './images/asset_QdoIs9v.png',
    width: 90,
    height: 90,
    fallbackText: 'Thi',
},
    'Blue Dragon': {
        src: './images/asset_K8Nf61W.png',
        width: 150,
        height: 150,
        fallbackText: 'Blu',
},
    'Skeleton': {
        src: './images/asset_aqz2BhZ.png',
        width: 90,
        height: 90,
        fallbackText: 'Ske',
 },
    'Ooze': {
        src: './images/asset_bw5bxXL.png',
        width: 120,
        height: 120,
        fallbackText: 'Ooz',
 },
    'Banshee': {
        src: './images/asset_eDqsh10.png',
        width: 90,
        height: 90,
        fallbackText: 'Ske',
 },
 'Black Dragon': {
        src: './images/asset_BjClt4D.png',
        width: 150,
        height: 150,
        fallbackText: 'Blu',
},
'Raptor': {
        src: './images/asset_VzONkiC.png',
        width: 105,
        height: 105,
        fallbackText: 'Rap',
},
'Megasaurus': {
        src: './images/asset_JjFq2lP.png',
        width: 150,
        height: 150,
        fallbackText: 'Meg',
},
'Nessiedon': {
        src: './images/asset_iwR4yRM.png',
        width: 125,
        height: 125,
        fallbackText: 'Nes',
},
'Green Dragon': {
        src: './images/asset_4Jmsp45.png',
        width: 150,
        height: 150,
        fallbackText: 'Gre',
},
...
const PLAYER_SPRITES = {
    // Barbarian
    'Barbarian': {
        src: './images/player_barbarian.png',
        width: 120,
        height: 120,
        fallbackText: 'BAR'
    },
...
function calculateEnemyStats(wave) { 
    ...
    // Log the before state for Barbarians using Rage
    if (actor.className === 'Barbarian' && actionDetails.type === 'Rage') {
        console.log(`Before setting: ${actor.name} rage status: ${actor.isRaging}`);
    }
    ...
    // For Rage type, explicitly set the isRaging flag here
    if (action.type === 'Rage' && actor.className === 'Barbarian') {
        actor.isRaging = true;
        console.log(`${actor.name} is now Raging (flag set in execution).`);
    }
    ...
    gameState.party.forEach(c => { 
        ...
        // Explicitly check if this is a Barbarian and if they are raging
        if (c.className === 'Barbarian' && c.isRaging) { 
            c.isRaging = false; 
            gameState.addLogMessage(`${c.name}'s rage ends.`); 
            console.log(`End of round: ${c.name}'s rage has ended.`);
            needsUpdate = true; 
        } 
    }); 
